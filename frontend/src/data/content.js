...
export const T = {
    es: {
        ...
        booking: {
            ...
            subtitle: "Paga $300 MXN de anticipo con Mercado Pago. Te notificaremos por correo cuando tu reserva esté confirmada.",
            name: "Nombre completo",
            phone: "Teléfono / WhatsApp",
            email: "Correo electrónico",
            emailHint: "Te notificaremos el estado de tu reserva",
            ...
            payCta: "PAGAR ANTICIPO Y RESERVAR",
            sending: "REDIRIGIENDO AL PAGO...",
            successTitle: "¡Reserva registrada!",
            successBody: "Revisa tu correo: te avisaremos cuando tu reserva esté confirmada.",
    ...
    en: {
        ...
        booking: {
            ...
            subtitle: "Pay the $300 MXN deposit via Mercado Pago. We'll email you when your booking is confirmed.",
            name: "Full name",
            phone: "Phone / WhatsApp",
            email: "Email address",
            emailHint: "We'll email you booking status updates",
            ...
            payCta: "PAY DEPOSIT & BOOK",
            sending: "REDIRECTING TO PAYMENT...",
            successTitle: "Booking saved!",
            successBody: "Check your email — we'll notify you when your booking is confirmed.",
